...
background = transform.scale(image.load('ocean.jpg'),(win_width,win_height))

player= Player('hero.png',5,win_height-80,4)
monster = Enemy('cyborg.png',win_width-80,280,2)
final=GameSprite('treasure.png',win_width-120,win_height - 80,0)

w1= Wall(79,41,203,100,20,450,10)
w2= Wall(79,41,203,100,480,350,10)
w3= Wall(79,41,203,100,20,10,380)
w4= Wall(79,41,203,440,200,10,280)
w5=Wall(79,41,203,440,200,150,10)
w6=Wall(79,41,203,590,100,10,110)
